...
for itarget=1:nvartot
    for isize = 1:maxsize
        if ~isempty(Otot_lagged(itarget,isize).inc_sig_red)
            Otot_lagged(itarget,isize).index_var_red(Otot_lagged(itarget,isize).inc_sig_red==0,:)=[];
            Otot_lagged(itarget,isize).sorted_red(Otot_lagged(itarget,isize).inc_sig_red==0)=[];
            Otot_lagged(itarget,isize).index_red(Otot_lagged(itarget,isize).inc_sig_red==0)=[];
            Otot_lagged(itarget,isize).bootsigCI_red(Otot_lagged(itarget,isize).inc_sig_red==0,:)=[];
            Otot_lagged(itarget,isize).bootsig_red(Otot_lagged(itarget,isize).inc_sig_red==0)=[];
            Otot_lagged(itarget,isize).inc_sig_red(Otot_lagged(itarget,isize).inc_sig_red==0)=[];
        end
        if ~isempty(Otot_lagged(itarget,isize).inc_sig_syn)
            Otot_lagged(itarget,isize).index_var_syn(Otot_lagged(itarget,isize).inc_sig_syn==0,:)=[];
            Otot_lagged(itarget,isize).sorted_syn(Otot_lagged(itarget,isize).inc_sig_syn==0)=[];
            Otot_lagged(itarget,isize).index_syn(Otot_lagged(itarget,isize).inc_sig_syn==0)=[];
            Otot_lagged(itarget,isize).bootsigCI_syn(Otot_lagged(itarget,isize).inc_sig_syn==0,:)=[];
            Otot_lagged(itarget,isize).bootsig_syn(Otot_lagged(itarget,isize).inc_sig_syn==0)=[];
            Otot_lagged(itarget,isize).inc_sig_syn(Otot_lagged(itarget,isize).inc_sig_syn==0)=[];
        end
    end
end
